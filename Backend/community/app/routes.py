...
from app.model import create_user, create_post, create_comment, serial_user, serial_post, serial_comment
...
def create_posts():
    ...
    try:
        ...
        post_id = mongo.db.posts.insert_one(new_post).inserted_id
...
def get_profile():
    try:
        ...
        return jsonify({
            ...
            'recent_comments': recent_comments[:5]  # Ensure we only return 5 comments
        }), 200

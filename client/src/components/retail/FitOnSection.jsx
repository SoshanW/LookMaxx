...
const FitOnSection = () => {
  ...
  const availableModels = [
    { name: 'T-Shirt', file: 'shirt.fbx', image: '/assets/retail/tshirt.png' },
    { name: 'Dress', file: 'dress.fbx', image: '/assets/retail/dress.png' },
    { name: 'Jacket', file: 'JACKET.fbx', image: '/assets/retail/jacket.png' },
  ];

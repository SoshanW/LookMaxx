        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            <div className="flex items-baseline">
              {/* PRICE SIZE: You can adjust the font size here - changed from text-5xl to text-3xl */}
              <motion.span 
              ...
              {showOriginalPrice && originalPrice && (
                /* ORIGINAL PRICE SIZE: You can adjust the font size here - changed from text-lg to text-sm */
                <motion.span 
